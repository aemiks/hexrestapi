    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire_time', models.PositiveIntegerField(blank=True, default=0, validators=[django.core.validators.MinValueValidator(10), django.core.validators.MaxValueValidator(30000)], verbose_name='Link expire time in [sec] - Only Enterprise Plan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='imagesapp.userplan')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('user_tier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='imagesapp.userplan')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='link_expire', to='imagesapp.userplan')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='thumbnail', to='imagesapp.userplan')),
            ],
        ),
    ]
